        ...
        set: function (value) {
          ...
          if (configExtraData) {
            Object.keys(configExtraData).forEach((key) => {
              if (
                configExtraData[key].allowNull === false &&
                typeof value[key] === 'undefined'
              ) {
                // TODO: dit wordt niet gechecked als je het veld helemaal niet meestuurt
                throw Error(`${key} is niet ingevuld`);
              }
              if (typeof value[key] == 'number') {
                // TODO: alles is nu int, maar dit is natuurlijk veel te simpel
